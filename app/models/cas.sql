...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2015 at 07:22 PM
...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `E_nic` varchar(20) COLLATE utf8_bin NOT NULL,
  `E_email` varchar(50) COLLATE utf8_bin NOT NULL,
  `E_tel` varchar(20) COLLATE utf8_bin NOT NULL,
  `E_address` varchar(255) COLLATE utf8_bin NOT NULL,
  `E_job_role` varchar(30) COLLATE utf8_bin NOT NULL,
  `E_image` varchar(255) COLLATE utf8_bin NOT NULL,
  `E_username` varchar(50) COLLATE utf8_bin NOT NULL,
  `E_password` char(100) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`Emp_ID`)
...
INSERT INTO `employee` (`Emp_ID`, `E_name`, `E_nic`, `E_email`, `E_tel`, `E_address`, `E_job_role`, `E_image`, `E_username`, `E_password`) VALUES
(1, 'Dilini weerasinghe', '916191197v', 'dweerasinghe91@gmail.com', '0718759697', 'Galketiya,Haliela, Badulla', 'General User', '', 'dweer', '0778759697'),
...
(8, 'Dili Madhubhashini', '916191197v', 'dweerasinghe91@gmail.com', '0718759697', 'Galketiya,Haliela, Badulla', 'Administrator', '', 'dweer', '0778759697');
