            ...
            (function() {
                ...
                function apply(out) {
                    ...
                    for (i = 0; i < response.length; i++) {
                        ...
                        var html = "<table id=\'world-map\' class=\'world-map\'><tr><td><b>Location</b></td><td>" + place + "</td></tr><tr><td><b>Occurence</b></td><td>" + date + "<br> " + time + "</td></tr><tr><tr><td><b>Magnitude</b></td><td>" + mag + "</td></tr><tr><td><b>Latitude</b></td><td>" + lat + "</td></tr><tr><td><b>Longitude</b></td><td>" + lng + "</td></tr><tr><tr><td><b>Tsunami</b></td><td>" + warning + "</td></tr></table>";
