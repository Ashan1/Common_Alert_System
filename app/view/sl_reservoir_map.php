            ...
            function initialize() {
                ...
                function apply(out){
                    ...
                    for (i = 0; i < response.length; i++){
                        ...
                        var html = "<table id = \'sl-map\' class = \'sl-map\' border='1'><th colspan = \'2\'>" + reservoir + "</th><tr><td><b>District</b></td><td>" + district + "</td></tr><tr><td><b>Co-ordinates</b></td><td>Lati - " + lat + "</br>Long - " + lng + "</td></tr><tr><td><b>Major Basin</b></td><td>" + basin + "</td></tr><tr><td><b>Catchment Area (ha)</b></td><td>" + catchment + "</td></tr><tr><td><b>Capacity @ F.S.L (MCM)</b></td><td>" + capacity + "</td></tr><tr><td><b>Specified Acerage (ha)</b></td><td>" + acerage + "</td></tr><tr><td><b>Maximum Bund Height(m)</b></td><td>" + bund_height + "</td></tr><tr><td><b>Full Supply Depth(m)</b></td><td>" + supply_depth + "</td></tr><tr><td><b>Water Depth above Sluice(m)</b></td><td>" + water_level + "</td></tr><tr><td><b>Reservoir Water Level</b></td><td>" + spill + "</td></tr><tr><td><b>Sluice Gate</b></td><td>" + sluice + "</td></tr></table>";
