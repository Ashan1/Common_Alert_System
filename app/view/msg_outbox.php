                        ...
                        <form name="form1" method="post" action="">
                            <table class="table table-striped" id="table">
                                ...
                                <div class="row">
                                    ...
                                    <div style="float: right;">
                                        <button class="div_button" type="submit" id="outbox" name="inbox">Inbox</button>
                                    </div>
                                    <div style="float:right;">
                                ...
                                for($i=0; $i<$count; $i++){
                                    ...
                                    echo
                                        ...
                                        <td><a href='msg_outbox.php?msg=".  $db_result[$i]->message ."'>{$msg_display}</a></td>
