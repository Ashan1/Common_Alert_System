...
>>>>>>> e92a1cb45e57c9dadccae3d1c431c2a90565b764
     ...
     <!-- /page-content-->
                            ...
                            <div style="float:right;">
                                <button class="div_button" data-toggle="modal" data-target="#myModal1" type="submit" id="update" ><img src="../../../public/images/refresh.png" class="div_button_img" >Update</button>
                            </div>

                            <div style="float:right;">
                                <button class="div_button" data-toggle="modal" type="submit" id="remove" name="delete" ><img src="../../../public/images/remove.png" class="div_button_img" action="../../../public/php/addnew.php">Remove</button></form>
                </div>
                ...
                <div style="float:right;">
                 ...
                 -->
                <!--edit_form-->
                <div class="modal fade " id="myModal1" data-backdrop="static" role="dialog" action="../../../public/php/update.php" >
                    <div class="modal-dialog">
                        <div class="row" style=" margin-top: 150px;margin-left: 90px;">
                            <div class="col-md-8 col-md-offset-2 model_addnew" style="width: 450px; height: 270px;" >
                                ...
                                <p style="color:white;">This can change user's current Job role.Do you want to change job role?</p>
                                <form class="form-horizontal" action="../../../public/php/update.php"  method="post">
                                    <div class="form-group ext_form">
                                        <div class="col-xs-10">
                                            <label style="color:white;">Current Job Role :</label>
                                            <input type="text" class="form-control modal_input" name="jobrole" id="currentjob" align="center" style="margin-left: 125px;width: 276px;" value="<?php echo $job?>">
                                            <label style="color:white;">New Job Role :</label>
                                            <select class="form-control modal_input " name="size" align="center" style="margin-left: 125px;width: 276px;">
