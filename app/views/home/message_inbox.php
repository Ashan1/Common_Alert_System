...
if(isset($_POST['delete1'])){
    for($i=0;$i<count($_POST['checkbox']);$i++){
        $del_id=$_POST['checkbox'][$i];
        $sql = "UPDATE message SET deleted = 'yes' WHERE id = '$del_id' or to_user = 'Dilini' ";
...
<div id="content" >
            ...
            while( $row = mysql_fetch_assoc( $query ) ){
                ...
                echo
                    "<tr>
                          ...
                          <td>{$row['from_user']}</td>
                          <td>{$row['message']}</td>
                          <td>" . "<input name='checkbox[]' type='checkbox' id='checkbox[]' class='box' value=$dbrow_id>$dbrow_id"."</td>
		            </tr>\n";
            }
            ?>
   ...
   /* }*/
    ...
    if (isset($_POST['delete'])) {
        ...
        $sql = mysql_query("UPDATE message SET deleted = 'yes' WHERE id = '$id' AND to_user = 'Dilini'")or die(mysql_error());
